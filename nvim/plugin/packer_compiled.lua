...
_G.packer_plugins = {
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/gijs/.config//share/nvim/site/pack/packer/opt/nvim-lsp-installer",
  ...
  ["nvim-lspconfig"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/gijs/.config//share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  vimspector = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/gijs/.config//share/nvim/site/pack/packer/opt/vimspector",
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'which-key.nvim', 'nvim-lspconfig'}, { event = "BufEnter *" }, _G.packer_plugins)]]
