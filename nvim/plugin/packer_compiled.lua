...
_G.packer_plugins = {
  ...
  ["nui.nvim"] = {
    loaded = true,
    path = "/home/gijs/.config//share/nvim/site/pack/packer/start/nui.nvim",
...
vim.cmd [[au BufAdd * ++once lua require("packer.load")({'indent-blankline.nvim'}, { event = "BufAdd *" }, _G.packer_plugins)]]
